...
<head>
    ...
    .preloader {
      ...
      .preloader__bg #gradient-canvas {
        /* opacity: 0.7; */
        width: 100%;
        height:100%;
        --gradient-color-1: #F9691D; 
        --gradient-color-2: #BA4000; 
        --gradient-color-3: #FFA012;  
        --gradient-color-4: #F9691D; 
        }
        .preloader__bg:after {
            content: "";
            position: absolute;
            ...
            right: 0;
            bottom: 0;
            background: url(<?php echo get_template_directory_uri()?>/img/gif.gif);
            opacity: 0.07;
        }
      .preloader-wrapper {
          z-index: 1002;
      ...
      .preloader__logo .preloader__lottie {
        width: 100%;
        height: auto;
      }
    ...
    <div class="preloader-wrapper">
        <div class="preloader-main">
            ...
            <div class="preloader__logo">
                ...
                loop
                mode="normal"
                src="<?php echo get_template_directory_uri()?>/logo-preloader.json"
                class="preloader__lottie"
                >
                </lottie-player>
            </div>
